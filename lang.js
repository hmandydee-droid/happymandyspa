const translations = {
  en: {
    ...
    offer1Text: "Massage + Facial + Aromatherapy",
    offer2Title: "Couple Retreat",
    offer2Text: "Exclusive 2-hour spa for couples",
    offer3Title: "Weekend Rejuvenation",
    offer3Text: "Body Scrub + Head Massage",

    whyUs: "Why Choose Us",
    why1: "Relaxing Ambiance",
    why2: "Skilled Therapists",
    why3: "Organic Products",
    why4: "Personalized Care",

    membership: "Membership Plans",
    plan1: "Silver",
    plan1Text: "2 therapies / month",
    plan2: "Gold",
    plan2Text: "5 therapies / month",
    plan3: "Platinum",
    ...
    faq1A: "Yes, advance booking is recommended to secure your preferred slot.",
    faq2Q: "What should I bring?",
    faq2A: "You don’t need to bring anything, we provide all essentials.",
    faq3Q: "Are your products safe for sensitive skin?",
    faq3A: "Absolutely! We use only premium organic and skin-safe products.",
  ...
  jp: {
    ...
    service3Text: "肌をリフレッシュし、若返らせるスクラブ。",
    service4Title: "アロマセラピー",
    service4Text: "心をリラックスさせ、体のバランスを整えるヒーリングオイル。",
    service5Title: "ヘアスパ",
    service5Text: "輝きを取り戻し、髪を強化するトリートメント。",
    service6Title: "カップルスパ",
    ...
    offer1Text: "マッサージ + フェイシャル + アロマセラピー",
    offer2Title: "カップルリトリート",
    offer2Text: "カップル専用の2時間スパ",
    offer3Title: "週末リジュベネーション",
    offer3Text: "ボディスクラブ + ヘッドマッサージ",
    ...
    reason1Title: "ラグジュアリーな雰囲気",
    reason1Text: "落ち着いた優雅な環境で心を癒します。",
    reason2Title: "熟練セラピスト",
    reason2Text: "経験豊富なスタッフが安全で効果的な施術を提供します。",
    reason3Title: "オーガニックトリートメント",
    reason3Text: "自然で高品質な製品のみを使用し、肌と体をリフレッシュ。",
    reason4Title: "お手頃な料金プラン",
    reason4Text: "すべての予算に合わせた高級スパ体験をお楽しみください。",
    reason5Title: "カップル・グループ向け",
